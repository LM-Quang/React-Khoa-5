...
xl:text-bold"
            ...
            <div className="mt-12">
               <div>
                  <div>
                     ...
                     <input name="taiKhoan" onChange={formik.handleChange} className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="text" placeholder="Enter User name" />
                  </div>
                  <div className="mt-8">
     ...
     shadow-lg"
               ...
               <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
                  ...
                  <a className="cursor-pointer text-indigo-600 hover:text-indigo-800" href="/">
                     Register
                  </a>
               </div>
            </div>
