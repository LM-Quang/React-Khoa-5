...
import { layThongTinPhimAction, capNhatPhimUploadAction } from "../../../../Redux/Actions/QuanLyPhimAction.js";
      ...
      <>
         ...
         >
            ...
            <Form.Item label="Ngày khởi chiếu">
               <DatePicker onChange={handleChangeDatePicker} format="DD/MM/YYYY" value={dayjs(moment(formik.values.ngayKhoiChieu).format("DD/MM/YYYY"), "DD/MM/YYYY")} />
            </Form.Item>
            ...
            <Form.Item label="Hình ảnh">
               ...
               <br />
               <img width={100} height={100} src={imgSrc === "" ? thongTinPhim.hinhAnh : imgSrc} alt="hinh anh phim" />
            </Form.Item>
